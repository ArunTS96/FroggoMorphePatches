...
> **[v1.0.2](https://github.com/ArunTS96/FroggoMorphePatches/releases/tag/v1.0.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;5 patches total
<details open>
...
|----------|----------------|-----------|
| [Block Facebook Feed ads and suggested posts (573)](#block-facebook-feed-ads-and-suggested-posts-573) | Blocks sponsored, promoted, and Facebook-recommended Feed posts in version 573 without touching Reels or Stories. |  |
